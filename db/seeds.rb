...
home_content = {
  ...
  # Shoutout video
  "shoutout_video_url"  => "https://res.cloudinary.com/wintan1418/video/upload/v1776372521/shout-out_ezrcu0.mp4",
  ...
  # Testimonials (short book quotes shown in the Voices rotator up top)
  "testimonials" => [
  ...
  # Real reader letters (scrolling wall near the bottom of the home page)
  "testimonial_letters" => [
